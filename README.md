...
The writing in `*.md` files, unless otherwise stated in the `.md` file itself, is available under the [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) license.
