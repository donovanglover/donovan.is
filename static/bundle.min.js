var U9=function(J){const j=J instanceof Element?J:J instanceof Node?J.parentElement:null,Q=j?j.closest("input, button"):null;return(Q===null||Q===void 0?void 0:Q.type)=="submit"?Q:null},B9=function(J){const j=U9(J.target);if(j&&j.form)f0.set(j.form,j)},q9=function(J){switch(J.toLowerCase()){case"lazy":return $.lazy;default:return $.eager}},C=function(J){return new URL(J.toString(),document.baseURI)},_=function(J){let j;if(J.hash)return J.hash.slice(1);else if(j=J.href.match(/#(.*)$/))return j[1]},N0=function(J,j){const Q=(j===null||j===void 0?void 0:j.getAttribute("formaction"))||J.getAttribute("action")||J.action;return C(Q)},V9=function(J){return(H9(J).match(/\.[^.]*$/)||[])[0]||""},N9=function(J){return!!V9(J).match(/^(?:|\.(?:htm|html|xhtml|php))$/)},O9=function(J,j){const Q=z9(j);return J.href===C(Q).href||J.href.startsWith(Q)},g=function(J,j){return O9(J,j)&&N9(J)},U0=function(J){const j=_(J);return j!=null?J.href.slice(0,-(j.length+1)):J.href},o=function(J){return U0(J)},Z9=function(J,j){return C(J).href==C(j).href},C9=function(J){return J.pathname.split("/").slice(1)},H9=function(J){return C9(J).slice(-1)[0]},z9=function(J){return A9(J.origin+J.pathname)},A9=function(J){return J.endsWith("/")?J:J+"/"},h=function(J){if(J.getAttribute("data-turbo-eval")=="false")return J;else{const j=document.createElement("script"),Q=n("csp-nonce");if(Q)j.nonce=Q;return j.textContent=J.textContent,j.async=!1,F9(j,J),j}},F9=function(J,j){for(let{name:Q,value:G}of j.attributes)J.setAttribute(Q,G)},M9=function(J){const j=document.createElement("template");return j.innerHTML=J,j.content},Z=function(J,{target:j,cancelable:Q,detail:G}={}){const Y=new CustomEvent(J,{cancelable:Q,bubbles:!0,composed:!0,detail:G});if(j&&j.isConnected)j.dispatchEvent(Y);else document.documentElement.dispatchEvent(Y);return Y},a=function(){return new Promise((J)=>requestAnimationFrame(()=>J()))},I9=function(){return new Promise((J)=>setTimeout(()=>J(),0))},k9=function(){return Promise.resolve()},v0=function(J=""){return new DOMParser().parseFromString(J,"text/html")},w0=function(J,...j){const Q=y9(J,j).replace(/^\n/,"").split("\n"),G=Q[0].match(/^\s+/),Y=G?G[0].length:0;return Q.map((K)=>K.slice(Y)).join("\n")},y9=function(J,j){return J.reduce((Q,G,Y)=>{const K=j[Y]==void 0?"":j[Y];return Q+G+K},"")},S=function(){return Array.from({length:36}).map((J,j)=>{if(j==8||j==13||j==18||j==23)return"-";else if(j==14)return"4";else if(j==19)return(Math.floor(Math.random()*4)+8).toString(16);else return Math.floor(Math.random()*15).toString(16)}).join("")},i=function(J,...j){for(let Q of j.map((G)=>G===null||G===void 0?void 0:G.getAttribute(J)))if(typeof Q=="string")return Q;return null},R9=function(J,...j){return j.some((Q)=>Q&&Q.hasAttribute(J))},B0=function(...J){for(let j of J){if(j.localName=="turbo-frame")j.setAttribute("busy","");j.setAttribute("aria-busy","true")}},q0=function(...J){for(let j of J){if(j.localName=="turbo-frame")j.removeAttribute("busy");j.removeAttribute("aria-busy")}},P9=function(J,j=2000){return new Promise((Q)=>{const G=()=>{J.removeEventListener("error",G),J.removeEventListener("load",G),Q()};J.addEventListener("load",G,{once:!0}),J.addEventListener("error",G,{once:!0}),setTimeout(Q,j)})},g0=function(J){switch(J){case"replace":return history.replaceState;case"advance":case"restore":return history.pushState}},T9=function(J){return J=="advance"||J=="replace"||J=="restore"},Q0=function(...J){const j=i("data-turbo-action",...J);return T9(j)?j:null},S0=function(J){return document.querySelector(`meta[name="${J}"]`)},n=function(J){const j=S0(J);return j&&j.content},D9=function(J,j){let Q=S0(J);if(!Q)Q=document.createElement("meta"),Q.setAttribute("name",J),document.head.appendChild(Q);return Q.setAttribute("content",j),Q},t=function(J,j){var Q;if(J instanceof Element)return J.closest(j)||t(J.assignedSlot||((Q=J.getRootNode())===null||Q===void 0?void 0:Q.host),j)},L9=function(J){switch(J.toLowerCase()){case"get":return z.get;case"post":return z.post;case"put":return z.put;case"patch":return z.patch;case"delete":return z.delete}},x9=function(J){for(let j of J.querySelectorAll("turbo-stream")){const Q=document.importNode(j,!0);for(let G of Q.templateElement.content.querySelectorAll("script"))G.replaceWith(h(G));j.replaceWith(Q)}return J},$9=function(J){switch(J.toLowerCase()){case x.multipart:return x.multipart;case x.plain:return x.plain;default:return x.urlEncoded}},b9=function(J,j){const Q=new FormData(J),G=j===null||j===void 0?void 0:j.getAttribute("name"),Y=j===null||j===void 0?void 0:j.getAttribute("value");if(G)Q.append(G,Y||"");return Q},E9=function(J){if(J!=null){const Q=(document.cookie?document.cookie.split("; "):[]).find((G)=>G.startsWith(J));if(Q){const G=Q.split("=").slice(1).join("=");return G?decodeURIComponent(G):void 0}}},_9=function(J){return J.statusCode==200&&!J.redirected},f9=function(J,j){const Q=new URLSearchParams;for(let[G,Y]of j){if(Y instanceof File)continue;Q.append(G,Y)}return J.search=Q.toString(),J},u0=function(J,j){return J.querySelector(`#${j}[data-turbo-permanent]`)},c0=function(J){return J.querySelectorAll("[id][data-turbo-permanent]")},v9=function(J,j){return((j===null||j===void 0?void 0:j.getAttribute("formmethod"))||J.getAttribute("method"))!="dialog"},w9=function(J,j){if((j===null||j===void 0?void 0:j.hasAttribute("formtarget"))||J.hasAttribute("target")){const Q=(j===null||j===void 0?void 0:j.getAttribute("formtarget"))||J.target;for(let G of document.getElementsByName(Q))if(G instanceof HTMLIFrameElement)return!1;return!0}else return!0},g9=function(J){if(J.hasAttribute("target")){for(let j of document.getElementsByName(J.target))if(j instanceof HTMLIFrameElement)return!1;return!0}else return!0},S9=function(J){const j=document.createElement("meta");return j.setAttribute("name","turbo-permanent-placeholder"),j.setAttribute("content",J.id),j},h9=function(J){return J&&typeof J.focus=="function"},u9=function(J,j){if(J=="end"||J=="start"||J=="center"||J=="nearest")return J;else return j},c9=function(J,j){if(J=="auto"||J=="smooth")return J;else return j},d9=function(J){if(m9(J))return"script";else if(r9(J))return"stylesheet"},p9=function(J){return J.getAttribute("data-turbo-track")=="reload"},m9=function(J){return J.localName=="script"},l9=function(J){return J.localName=="noscript"},r9=function(J){const j=J.localName;return j=="style"||j=="link"&&J.getAttribute("rel")=="stylesheet"},s9=function(J,j){return J.localName=="meta"&&J.getAttribute("name")==j},o9=function(J){if(J.hasAttribute("nonce"))J.setAttribute("nonce","");return J},$0=function(J){return J>=200&&J<300},i9=function(J){const j=c0(document.documentElement),Q={};for(let G of j){const{id:Y}=G;for(let K of J.querySelectorAll("turbo-stream")){const X=u0(K.templateElement.content,Y);if(X)Q[Y]=[G,X]}}return Q},n9=function(J){var j;const Q=(j=J.detail)===null||j===void 0?void 0:j.fetchResponse;if(Q instanceof j0)return Q},t9=function(J){var j;return((j=J.contentType)!==null&&j!==void 0?j:"").startsWith(E.contentType)},b0=function(J){Object.defineProperties(J,e9)},X1=function(){N.start()},QJ=function(J){N.registerAdapter(J)},GJ=function(J,j){N.visit(J,j)},W1=function(J){N.connectStreamSource(J)},U1=function(J){N.disconnectStreamSource(J)},YJ=function(J){N.renderStreamMessage(J)},KJ=function(){console.warn("Please replace `Turbo.clearCache()` with `Turbo.cache.clear()`. The top-level function is deprecated and will be removed in a future version of Turbo.`"),N.clearCache()},XJ=function(J){N.setProgressBarDelay(J)},WJ=function(J){u.confirmMethod=J},UJ=function(J){N.setFormMode(J)},E0=function(J){if(J!=null){const j=document.getElementById(J);if(j instanceof T)return j}},_0=function(J,j){if(J){const Q=J.getAttribute("src");if(Q!=null&&j!=null&&Z9(Q,j))throw new Error(`Matching <turbo-frame id="${J.id}"> element has a source URL which references itself`);if(J.ownerDocument!==document)J=document.importNode(J,!0);if(J instanceof T)return J.connectedCallback(),J.disconnectedCallback(),J}};(function(){if(window.Reflect===void 0||window.customElements===void 0||window.customElements.polyfillWrapFlushCallback)return;const J=HTMLElement,j={HTMLElement:function Q(){return Reflect.construct(J,[],this.constructor)}};window.HTMLElement=j.HTMLElement,HTMLElement.prototype=J.prototype,HTMLElement.prototype.constructor=HTMLElement,Object.setPrototypeOf(HTMLElement,J)})();(function(J){if(typeof J.requestSubmit=="function")return;J.requestSubmit=function(G){if(G)j(G,this),G.click();else G=document.createElement("input"),G.type="submit",G.hidden=!0,this.appendChild(G),G.click(),this.removeChild(G)};function j(G,Y){G instanceof HTMLElement||Q(TypeError,"parameter 1 is not of type 'HTMLElement'"),G.type=="submit"||Q(TypeError,"The specified element is not a submit button"),G.form==Y||Q(DOMException,"The specified element is not owned by this form element","NotFoundError")}function Q(G,Y,K){throw new G("Failed to execute 'requestSubmit' on 'HTMLFormElement': "+Y+".",K)}})(HTMLFormElement.prototype);var f0=new WeakMap;(function(){if("submitter"in Event.prototype)return;let J=window.Event.prototype;if(("SubmitEvent"in window)&&/Apple Computer/.test(navigator.vendor))J=window.SubmitEvent.prototype;else if("SubmitEvent"in window)return;addEventListener("click",B9,!0),Object.defineProperty(J,"submitter",{get(){if(this.type=="submit"&&this.target instanceof HTMLFormElement)return f0.get(this.target)}})})();var $;(function(J){J.eager="eager",J.lazy="lazy"})($||($={}));class T extends HTMLElement{static get observedAttributes(){return["disabled","complete","loading","src"]}constructor(){super();this.loaded=Promise.resolve(),this.delegate=new T.delegateConstructor(this)}connectedCallback(){this.delegate.connect()}disconnectedCallback(){this.delegate.disconnect()}reload(){return this.delegate.sourceURLReloaded()}attributeChangedCallback(J){if(J=="loading")this.delegate.loadingStyleChanged();else if(J=="complete")this.delegate.completeChanged();else if(J=="src")this.delegate.sourceURLChanged();else this.delegate.disabledChanged()}get src(){return this.getAttribute("src")}set src(J){if(J)this.setAttribute("src",J);else this.removeAttribute("src")}get loading(){return q9(this.getAttribute("loading")||"")}set loading(J){if(J)this.setAttribute("loading",J);else this.removeAttribute("loading")}get disabled(){return this.hasAttribute("disabled")}set disabled(J){if(J)this.setAttribute("disabled","");else this.removeAttribute("disabled")}get autoscroll(){return this.hasAttribute("autoscroll")}set autoscroll(J){if(J)this.setAttribute("autoscroll","");else this.removeAttribute("autoscroll")}get complete(){return!this.delegate.isLoading}get isActive(){return this.ownerDocument===document&&!this.isPreview}get isPreview(){var J,j;return(j=(J=this.ownerDocument)===null||J===void 0?void 0:J.documentElement)===null||j===void 0?void 0:j.hasAttribute("data-turbo-preview")}}class j0{constructor(J){this.response=J}get succeeded(){return this.response.ok}get failed(){return!this.succeeded}get clientError(){return this.statusCode>=400&&this.statusCode<=499}get serverError(){return this.statusCode>=500&&this.statusCode<=599}get redirected(){return this.response.redirected}get location(){return C(this.response.url)}get isHTML(){return this.contentType&&this.contentType.match(/^(?:text\/([^\s;,]+\b)?html|application\/xhtml\+xml)\b/)}get statusCode(){return this.response.status}get contentType(){return this.header("Content-Type")}get responseText(){return this.response.clone().text()}get responseHTML(){if(this.isHTML)return this.response.clone().text();else return Promise.resolve(void 0)}header(J){return this.response.headers.get(J)}}var z;(function(J){J[J.get=0]="get",J[J.post=1]="post",J[J.put=2]="put",J[J.patch=3]="patch",J[J.delete=4]="delete"})(z||(z={}));class G0{constructor(J,j,Q,G=new URLSearchParams,Y=null){this.abortController=new AbortController,this.resolveRequestPromise=(K)=>{},this.delegate=J,this.method=j,this.headers=this.defaultHeaders,this.body=G,this.url=Q,this.target=Y}get location(){return this.url}get params(){return this.url.searchParams}get entries(){return this.body?Array.from(this.body.entries()):[]}cancel(){this.abortController.abort()}async perform(){const{fetchOptions:J}=this;this.delegate.prepareRequest(this),await this.allowRequestToBeIntercepted(J);try{this.delegate.requestStarted(this);const j=await fetch(this.url.href,J);return await this.receive(j)}catch(j){if(j.name!=="AbortError"){if(this.willDelegateErrorHandling(j))this.delegate.requestErrored(this,j);throw j}}finally{this.delegate.requestFinished(this)}}async receive(J){const j=new j0(J);if(Z("turbo:before-fetch-response",{cancelable:!0,detail:{fetchResponse:j},target:this.target}).defaultPrevented)this.delegate.requestPreventedHandlingResponse(this,j);else if(j.succeeded)this.delegate.requestSucceededWithResponse(this,j);else this.delegate.requestFailedWithResponse(this,j);return j}get fetchOptions(){var J;return{method:z[this.method].toUpperCase(),credentials:"same-origin",headers:this.headers,redirect:"follow",body:this.isSafe?null:this.body,signal:this.abortSignal,referrer:(J=this.delegate.referrer)===null||J===void 0?void 0:J.href}}get defaultHeaders(){return{Accept:"text/html, application/xhtml+xml"}}get isSafe(){return this.method===z.get}get abortSignal(){return this.abortController.signal}acceptResponseType(J){this.headers.Accept=[J,this.headers.Accept].join(", ")}async allowRequestToBeIntercepted(J){const j=new Promise((G)=>this.resolveRequestPromise=G);if(Z("turbo:before-fetch-request",{cancelable:!0,detail:{fetchOptions:J,url:this.url,resume:this.resolveRequestPromise},target:this.target}).defaultPrevented)await j}willDelegateErrorHandling(J){return!Z("turbo:fetch-request-error",{target:this.target,cancelable:!0,detail:{request:this,error:J}}).defaultPrevented}}class h0{constructor(J,j){this.started=!1,this.intersect=(Q)=>{const G=Q.slice(-1)[0];if(G===null||G===void 0?void 0:G.isIntersecting)this.delegate.elementAppearedInViewport(this.element)},this.delegate=J,this.element=j,this.intersectionObserver=new IntersectionObserver(this.intersect)}start(){if(!this.started)this.started=!0,this.intersectionObserver.observe(this.element)}stop(){if(this.started)this.started=!1,this.intersectionObserver.unobserve(this.element)}}class E{static wrap(J){if(typeof J=="string")return new this(M9(J));else return J}constructor(J){this.fragment=x9(J)}}E.contentType="text/vnd.turbo-stream.html";var L;(function(J){J[J.initialized=0]="initialized",J[J.requesting=1]="requesting",J[J.waiting=2]="waiting",J[J.receiving=3]="receiving",J[J.stopping=4]="stopping",J[J.stopped=5]="stopped"})(L||(L={}));var x;(function(J){J.urlEncoded="application/x-www-form-urlencoded",J.multipart="multipart/form-data",J.plain="text/plain"})(x||(x={}));class u{static confirmMethod(J,j,Q){return Promise.resolve(confirm(J))}constructor(J,j,Q,G=!1){if(this.state=L.initialized,this.delegate=J,this.formElement=j,this.submitter=Q,this.formData=b9(j,Q),this.location=C(this.action),this.method==z.get)f9(this.location,[...this.body.entries()]);this.fetchRequest=new G0(this,this.method,this.location,this.body,this.formElement),this.mustRedirect=G}get method(){var J;const j=((J=this.submitter)===null||J===void 0?void 0:J.getAttribute("formmethod"))||this.formElement.getAttribute("method")||"";return L9(j.toLowerCase())||z.get}get action(){var J;const j=typeof this.formElement.action==="string"?this.formElement.action:null;if((J=this.submitter)===null||J===void 0?void 0:J.hasAttribute("formaction"))return this.submitter.getAttribute("formaction")||"";else return this.formElement.getAttribute("action")||j||""}get body(){if(this.enctype==x.urlEncoded||this.method==z.get)return new URLSearchParams(this.stringFormData);else return this.formData}get enctype(){var J;return $9(((J=this.submitter)===null||J===void 0?void 0:J.getAttribute("formenctype"))||this.formElement.enctype)}get isSafe(){return this.fetchRequest.isSafe}get stringFormData(){return[...this.formData].reduce((J,[j,Q])=>{return J.concat(typeof Q=="string"?[[j,Q]]:[])},[])}async start(){const{initialized:J,requesting:j}=L,Q=i("data-turbo-confirm",this.submitter,this.formElement);if(typeof Q==="string"){if(!await u.confirmMethod(Q,this.formElement,this.submitter))return}if(this.state==J)return this.state=j,this.fetchRequest.perform()}stop(){const{stopping:J,stopped:j}=L;if(this.state!=J&&this.state!=j)return this.state=J,this.fetchRequest.cancel(),!0}prepareRequest(J){if(!J.isSafe){const j=E9(n("csrf-param"))||n("csrf-token");if(j)J.headers["X-CSRF-Token"]=j}if(this.requestAcceptsTurboStreamResponse(J))J.acceptResponseType(E.contentType)}requestStarted(J){var j;this.state=L.waiting,(j=this.submitter)===null||j===void 0||j.setAttribute("disabled",""),this.setSubmitsWith(),Z("turbo:submit-start",{target:this.formElement,detail:{formSubmission:this}}),this.delegate.formSubmissionStarted(this)}requestPreventedHandlingResponse(J,j){this.result={success:j.succeeded,fetchResponse:j}}requestSucceededWithResponse(J,j){if(j.clientError||j.serverError)this.delegate.formSubmissionFailedWithResponse(this,j);else if(this.requestMustRedirect(J)&&_9(j)){const Q=new Error("Form responses must redirect to another location");this.delegate.formSubmissionErrored(this,Q)}else this.state=L.receiving,this.result={success:!0,fetchResponse:j},this.delegate.formSubmissionSucceededWithResponse(this,j)}requestFailedWithResponse(J,j){this.result={success:!1,fetchResponse:j},this.delegate.formSubmissionFailedWithResponse(this,j)}requestErrored(J,j){this.result={success:!1,error:j},this.delegate.formSubmissionErrored(this,j)}requestFinished(J){var j;this.state=L.stopped,(j=this.submitter)===null||j===void 0||j.removeAttribute("disabled"),this.resetSubmitterText(),Z("turbo:submit-end",{target:this.formElement,detail:Object.assign({formSubmission:this},this.result)}),this.delegate.formSubmissionFinished(this)}setSubmitsWith(){if(!this.submitter||!this.submitsWith)return;if(this.submitter.matches("button"))this.originalSubmitText=this.submitter.innerHTML,this.submitter.innerHTML=this.submitsWith;else if(this.submitter.matches("input")){const J=this.submitter;this.originalSubmitText=J.value,J.value=this.submitsWith}}resetSubmitterText(){if(!this.submitter||!this.originalSubmitText)return;if(this.submitter.matches("button"))this.submitter.innerHTML=this.originalSubmitText;else if(this.submitter.matches("input")){const J=this.submitter;J.value=this.originalSubmitText}}requestMustRedirect(J){return!J.isSafe&&this.mustRedirect}requestAcceptsTurboStreamResponse(J){return!J.isSafe||R9("data-turbo-stream",this.submitter,this.formElement)}get submitsWith(){var J;return(J=this.submitter)===null||J===void 0?void 0:J.getAttribute("data-turbo-submits-with")}}class c{constructor(J){this.element=J}get activeElement(){return this.element.ownerDocument.activeElement}get children(){return[...this.element.children]}hasAnchor(J){return this.getElementForAnchor(J)!=null}getElementForAnchor(J){return J?this.element.querySelector(`[id='${J}'], a[name='${J}']`):null}get isConnected(){return this.element.isConnected}get firstAutofocusableElement(){for(let j of this.element.querySelectorAll("[autofocus]"))if(j.closest("[inert], :disabled, [hidden], details:not([open]), dialog:not([open])")==null)return j;else continue;return null}get permanentElements(){return c0(this.element)}getPermanentElementById(J){return u0(this.element,J)}getPermanentElementMapForSnapshot(J){const j={};for(let Q of this.permanentElements){const{id:G}=Q,Y=J.getPermanentElementById(G);if(Y)j[G]=[Q,Y]}return j}}class Y0{constructor(J,j){this.started=!1,this.submitCaptured=()=>{this.eventTarget.removeEventListener("submit",this.submitBubbled,!1),this.eventTarget.addEventListener("submit",this.submitBubbled,!1)},this.submitBubbled=(Q)=>{if(!Q.defaultPrevented){const G=Q.target instanceof HTMLFormElement?Q.target:void 0,Y=Q.submitter||void 0;if(G&&v9(G,Y)&&w9(G,Y)&&this.delegate.willSubmitForm(G,Y))Q.preventDefault(),Q.stopImmediatePropagation(),this.delegate.formSubmitted(G,Y)}},this.delegate=J,this.eventTarget=j}start(){if(!this.started)this.eventTarget.addEventListener("submit",this.submitCaptured,!0),this.started=!0}stop(){if(this.started)this.eventTarget.removeEventListener("submit",this.submitCaptured,!0),this.started=!1}}class O0{constructor(J,j){this.resolveRenderPromise=(Q)=>{},this.resolveInterceptionPromise=(Q)=>{},this.delegate=J,this.element=j}scrollToAnchor(J){const j=this.snapshot.getElementForAnchor(J);if(j)this.scrollToElement(j),this.focusElement(j);else this.scrollToPosition({x:0,y:0})}scrollToAnchorFromLocation(J){this.scrollToAnchor(_(J))}scrollToElement(J){J.scrollIntoView()}focusElement(J){if(J instanceof HTMLElement)if(J.hasAttribute("tabindex"))J.focus();else J.setAttribute("tabindex","-1"),J.focus(),J.removeAttribute("tabindex")}scrollToPosition({x:J,y:j}){this.scrollRoot.scrollTo(J,j)}scrollToTop(){this.scrollToPosition({x:0,y:0})}get scrollRoot(){return window}async render(J){const{isPreview:j,shouldRender:Q,newSnapshot:G}=J;if(Q)try{this.renderPromise=new Promise((W)=>this.resolveRenderPromise=W),this.renderer=J,await this.prepareToRenderSnapshot(J);const Y=new Promise((W)=>this.resolveInterceptionPromise=W),K={resume:this.resolveInterceptionPromise,render:this.renderer.renderElement};if(!this.delegate.allowsImmediateRender(G,K))await Y;await this.renderSnapshot(J),this.delegate.viewRenderedSnapshot(G,j),this.delegate.preloadOnLoadLinksForView(this.element),this.finishRenderingSnapshot(J)}finally{delete this.renderer,this.resolveRenderPromise(void 0),delete this.renderPromise}else this.invalidate(J.reloadReason)}invalidate(J){this.delegate.viewInvalidated(J)}async prepareToRenderSnapshot(J){this.markAsPreview(J.isPreview),await J.prepareToRender()}markAsPreview(J){if(J)this.element.setAttribute("data-turbo-preview","");else this.element.removeAttribute("data-turbo-preview")}async renderSnapshot(J){await J.render()}finishRenderingSnapshot(J){J.finishRendering()}}class d0 extends O0{missing(){this.element.innerHTML='<strong class="turbo-frame-error">Content missing</strong>'}get snapshot(){return new c(this.element)}}class Z0{constructor(J,j){this.clickBubbled=(Q)=>{if(this.respondsToEventTarget(Q.target))this.clickEvent=Q;else delete this.clickEvent},this.linkClicked=(Q)=>{if(this.clickEvent&&this.respondsToEventTarget(Q.target)&&Q.target instanceof Element){if(this.delegate.shouldInterceptLinkClick(Q.target,Q.detail.url,Q.detail.originalEvent))this.clickEvent.preventDefault(),Q.preventDefault(),this.delegate.linkClickIntercepted(Q.target,Q.detail.url,Q.detail.originalEvent)}delete this.clickEvent},this.willVisit=(Q)=>{delete this.clickEvent},this.delegate=J,this.element=j}start(){this.element.addEventListener("click",this.clickBubbled),document.addEventListener("turbo:click",this.linkClicked),document.addEventListener("turbo:before-visit",this.willVisit)}stop(){this.element.removeEventListener("click",this.clickBubbled),document.removeEventListener("turbo:click",this.linkClicked),document.removeEventListener("turbo:before-visit",this.willVisit)}respondsToEventTarget(J){const j=J instanceof Element?J:J instanceof Node?J.parentElement:null;return j&&j.closest("turbo-frame, html")==this.element}}class C0{constructor(J,j){this.started=!1,this.clickCaptured=()=>{this.eventTarget.removeEventListener("click",this.clickBubbled,!1),this.eventTarget.addEventListener("click",this.clickBubbled,!1)},this.clickBubbled=(Q)=>{if(Q instanceof MouseEvent&&this.clickEventIsSignificant(Q)){const G=Q.composedPath&&Q.composedPath()[0]||Q.target,Y=this.findLinkFromClickTarget(G);if(Y&&g9(Y)){const K=this.getLocationForLink(Y);if(this.delegate.willFollowLinkToLocation(Y,K,Q))Q.preventDefault(),this.delegate.followedLinkToLocation(Y,K)}}},this.delegate=J,this.eventTarget=j}start(){if(!this.started)this.eventTarget.addEventListener("click",this.clickCaptured,!0),this.started=!0}stop(){if(this.started)this.eventTarget.removeEventListener("click",this.clickCaptured,!0),this.started=!1}clickEventIsSignificant(J){return!(J.target&&J.target.isContentEditable||J.defaultPrevented||J.which>1||J.altKey||J.ctrlKey||J.metaKey||J.shiftKey)}findLinkFromClickTarget(J){return t(J,"a[href]:not([target^=_]):not([download])")}getLocationForLink(J){return C(J.getAttribute("href")||"")}}class H0{constructor(J,j){this.delegate=J,this.linkInterceptor=new C0(this,j)}start(){this.linkInterceptor.start()}stop(){this.linkInterceptor.stop()}willFollowLinkToLocation(J,j,Q){return this.delegate.willSubmitFormLinkToLocation(J,j,Q)&&J.hasAttribute("data-turbo-method")}followedLinkToLocation(J,j){const Q=document.createElement("form");for(let[q,V]of j.searchParams)Q.append(Object.assign(document.createElement("input"),{type:"hidden",name:q,value:V}));const Y=Object.assign(j,{search:""});Q.setAttribute("data-turbo","true"),Q.setAttribute("action",Y.href),Q.setAttribute("hidden","");const K=J.getAttribute("data-turbo-method");if(K)Q.setAttribute("method",K);const X=J.getAttribute("data-turbo-frame");if(X)Q.setAttribute("data-turbo-frame",X);const W=Q0(J);if(W)Q.setAttribute("data-turbo-action",W);const U=J.getAttribute("data-turbo-confirm");if(U)Q.setAttribute("data-turbo-confirm",U);if(J.hasAttribute("data-turbo-stream"))Q.setAttribute("data-turbo-stream","");this.delegate.submittedFormLinkToLocation(J,j,Q),document.body.appendChild(Q),Q.addEventListener("turbo:submit-end",()=>Q.remove(),{once:!0}),requestAnimationFrame(()=>Q.requestSubmit())}}class z0{static async preservingPermanentElements(J,j,Q){const G=new this(J,j);G.enter(),await Q(),G.leave()}constructor(J,j){this.delegate=J,this.permanentElementMap=j}enter(){for(let J in this.permanentElementMap){const[j,Q]=this.permanentElementMap[J];this.delegate.enteringBardo(j,Q),this.replaceNewPermanentElementWithPlaceholder(Q)}}leave(){for(let J in this.permanentElementMap){const[j]=this.permanentElementMap[J];this.replaceCurrentPermanentElementWithClone(j),this.replacePlaceholderWithPermanentElement(j),this.delegate.leavingBardo(j)}}replaceNewPermanentElementWithPlaceholder(J){const j=S9(J);J.replaceWith(j)}replaceCurrentPermanentElementWithClone(J){const j=J.cloneNode(!0);J.replaceWith(j)}replacePlaceholderWithPermanentElement(J){const j=this.getPlaceholderById(J.id);j===null||j===void 0||j.replaceWith(J)}getPlaceholderById(J){return this.placeholders.find((j)=>j.content==J)}get placeholders(){return[...document.querySelectorAll("meta[name=turbo-permanent-placeholder][content]")]}}class K0{constructor(J,j,Q,G,Y=!0){this.activeElement=null,this.currentSnapshot=J,this.newSnapshot=j,this.isPreview=G,this.willRender=Y,this.renderElement=Q,this.promise=new Promise((K,X)=>this.resolvingFunctions={resolve:K,reject:X})}get shouldRender(){return!0}get reloadReason(){return}prepareToRender(){return}finishRendering(){if(this.resolvingFunctions)this.resolvingFunctions.resolve(),delete this.resolvingFunctions}async preservingPermanentElements(J){await z0.preservingPermanentElements(this,this.permanentElementMap,J)}focusFirstAutofocusableElement(){const J=this.connectedSnapshot.firstAutofocusableElement;if(h9(J))J.focus()}enteringBardo(J){if(this.activeElement)return;if(J.contains(this.currentSnapshot.activeElement))this.activeElement=this.currentSnapshot.activeElement}leavingBardo(J){if(J.contains(this.activeElement)&&this.activeElement instanceof HTMLElement)this.activeElement.focus(),this.activeElement=null}get connectedSnapshot(){return this.newSnapshot.isConnected?this.newSnapshot:this.currentSnapshot}get currentElement(){return this.currentSnapshot.element}get newElement(){return this.newSnapshot.element}get permanentElementMap(){return this.currentSnapshot.getPermanentElementMapForSnapshot(this.newSnapshot)}}class e extends K0{static renderElement(J,j){var Q;const G=document.createRange();G.selectNodeContents(J),G.deleteContents();const Y=j,K=(Q=Y.ownerDocument)===null||Q===void 0?void 0:Q.createRange();if(K)K.selectNodeContents(Y),J.appendChild(K.extractContents())}constructor(J,j,Q,G,Y,K=!0){super(j,Q,G,Y,K);this.delegate=J}get shouldRender(){return!0}async render(){await a(),this.preservingPermanentElements(()=>{this.loadFrameElement()}),this.scrollFrameIntoView(),await a(),this.focusFirstAutofocusableElement(),await a(),this.activateScriptElements()}loadFrameElement(){this.delegate.willRenderFrame(this.currentElement,this.newElement),this.renderElement(this.currentElement,this.newElement)}scrollFrameIntoView(){if(this.currentElement.autoscroll||this.newElement.autoscroll){const J=this.currentElement.firstElementChild,j=u9(this.currentElement.getAttribute("data-autoscroll-block"),"end"),Q=c9(this.currentElement.getAttribute("data-autoscroll-behavior"),"auto");if(J)return J.scrollIntoView({block:j,behavior:Q}),!0}return!1}activateScriptElements(){for(let J of this.newScriptElements){const j=h(J);J.replaceWith(j)}}get newScriptElements(){return this.currentElement.querySelectorAll("script")}}class P{static get defaultCSS(){return w0`
      .turbo-progress-bar {
        position: fixed;
        display: block;
        top: 0;
